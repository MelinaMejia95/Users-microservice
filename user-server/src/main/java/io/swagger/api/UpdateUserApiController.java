...
public class UpdateUserApiController implements UpdateUserApi {
    ...
    public ResponseEntity<JsonApiBodyResponseSuccess> updateUserPut(@ApiParam(value = "" ,required=true )  @Valid @RequestBody JsonApiBodyRequest body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<JsonApiBodyResponseSuccess>(objectMapper.readValue("{  \"name\" : \"name\",  \"id\" : \"id\"}", JsonApiBodyResponseSuccess.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
