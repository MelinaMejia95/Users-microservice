...
public interface DeleteUserApi {
    ...
    @ApiOperation(value = "Delete user from the database", nickname = "deleteUserIdDelete", notes = "Delete user from the database", response = JsonApiBodyRequest.class, tags={ "Users", })
    @ApiResponses(value = { 
