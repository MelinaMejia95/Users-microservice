...
public class GetUsersApiController implements GetUsersApi {
    ...
    public ResponseEntity<JsonApiBodyRequest> getUsersGet() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<JsonApiBodyRequest>(objectMapper.readValue("{  \"movies\" : [ {    \"date\" : \"date\",    \"name\" : \"name\",    \"telephone\" : \"telephone\",    \"id\" : \"id\",    \"type\" : \"type\",    \"email\" : \"email\"  }, {    \"date\" : \"date\",    \"name\" : \"name\",    \"telephone\" : \"telephone\",    \"id\" : \"id\",    \"type\" : \"type\",    \"email\" : \"email\"  } ]}", JsonApiBodyRequest.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<JsonApiBodyRequest> getUsersIdGet(@ApiParam(value = "User id",required=true) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<JsonApiBodyRequest>(objectMapper.readValue("{  \"movies\" : [ {    \"date\" : \"date\",    \"name\" : \"name\",    \"telephone\" : \"telephone\",    \"id\" : \"id\",    \"type\" : \"type\",    \"email\" : \"email\"  }, {    \"date\" : \"date\",    \"name\" : \"name\",    \"telephone\" : \"telephone\",    \"id\" : \"id\",    \"type\" : \"type\",    \"email\" : \"email\"  } ]}", JsonApiBodyRequest.class), HttpStatus.NOT_IMPLEMENTED);
